...
%          Written by Anders Forsgren, KTH Royal Institute of Technology
%          For student use in the KTH course SF1811 Optimization
...
%
%          Ineqplot plots the indquality constraint { x | a'*x =< b }, i.e.,
